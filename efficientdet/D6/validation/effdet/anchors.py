...
def generate_detections(
    ...
    #print(cls_outputs.shape, cls_outputs.sigmoid().shape, cls_outputs.sigmoid().squeeze(1).shape)
    #print(cls_outputs[:5],"AAA")
    #print(cls_outputs.sigmoid()[:5],"BBB")
    ...
    if soft_nms:
        ...
        top_detection_idx = batched_nms(boxes, scores, classes, iou_threshold=0.45)
