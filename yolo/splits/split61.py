...
########################################################################################################
train_image_dir = 'split61/fold0/images/train/'
if not os.path.exists(train_image_dir):
    os.makedirs(train_image_dir)
valid_image_dir = 'split61/fold0/images/valid/'
if not os.path.exists(valid_image_dir):
    os.makedirs(valid_image_dir)
train_label_dir = 'split61/fold0/labels/train/'
if not os.path.exists(train_label_dir):
    os.makedirs(train_label_dir)
valid_label_dir = 'split61/fold0/labels/valid/'
...
train_image_dir = 'split61/fold1/images/train/'
if not os.path.exists(train_image_dir):
    os.makedirs(train_image_dir)
valid_image_dir = 'split61/fold1/images/valid/'
if not os.path.exists(valid_image_dir):
    os.makedirs(valid_image_dir)
train_label_dir = 'split61/fold1/labels/train/'
if not os.path.exists(train_label_dir):
    os.makedirs(train_label_dir)
valid_label_dir = 'split61/fold1/labels/valid/'
if not os.path.exists(valid_label_dir):
    os.makedirs(valid_label_dir)
...
train_image_dir = 'split61/fold2/images/train/'
if not os.path.exists(train_image_dir):
    os.makedirs(train_image_dir)
valid_image_dir = 'split61/fold2/images/valid/'
if not os.path.exists(valid_image_dir):
    os.makedirs(valid_image_dir)
train_label_dir = 'split61/fold2/labels/train/'
if not os.path.exists(train_label_dir):
    os.makedirs(train_label_dir)
valid_label_dir = 'split61/fold2/labels/valid/'
if not os.path.exists(valid_label_dir):
    os.makedirs(valid_label_dir)
...
train_image_dir = 'split61/fold3/images/train/'
if not os.path.exists(train_image_dir):
    os.makedirs(train_image_dir)
valid_image_dir = 'split61/fold3/images/valid/'
if not os.path.exists(valid_image_dir):
    os.makedirs(valid_image_dir)
train_label_dir = 'split61/fold3/labels/train/'
if not os.path.exists(train_label_dir):
    os.makedirs(train_label_dir)
valid_label_dir = 'split61/fold3/labels/valid/'
if not os.path.exists(valid_label_dir):
    os.makedirs(valid_label_dir)
...
train_image_dir = 'split61/fold4/images/train/'
if not os.path.exists(train_image_dir):
    os.makedirs(train_image_dir)
valid_image_dir = 'split61/fold4/images/valid/'
if not os.path.exists(valid_image_dir):
    os.makedirs(valid_image_dir)
train_label_dir = 'split61/fold4/labels/train/'
if not os.path.exists(train_label_dir):
    os.makedirs(train_label_dir)
valid_label_dir = 'split61/fold4/labels/valid/'
if not os.path.exists(valid_label_dir):
    os.makedirs(valid_label_dir)
